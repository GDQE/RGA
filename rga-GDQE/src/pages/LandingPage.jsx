...
// أيقونات SVG بسيطة بدل الإيموجي — أكثر احترافية ومتناسقة مع الهوية البصرية
const IconExam = ({ color }) => (
...
const IconFirm = ({ color }) => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <rect x="4" y="3" width="16" height="18" rx="1" />
    <path d="M9 7h1M9 11h1M9 15h1M14 7h1M14 11h1M14 15h1M9 21v-4h6v4" />
  </svg>
);
